...
//Thêm dự án
duanRouter.post('/duan', checkRole('director'), duanController.postDuAn);
//Xóa dự án
duanRouter.delete('/duan/:id', checkRole('director'), duanController.deleteDuAn);
//lấy hết dự án
duanRouter.get('/duan', checkRole(['director', 'manager']), duanController.getAllDuAn);
//sửa dự án
duanRouter.put('/duan/:id', checkRole('director'), duanController.putDuAn);
